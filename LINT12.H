...
#define LDIGIT          LDATA
#define LDIGITC         LDATAC 

#define LDIGIT_SIZE     LCELL_DATA_SIZE
...
extern const byte Lint12Zero [ LDIGIT_SIZE ];   /* 0 */
extern const byte Lint12One  [ LDIGIT_SIZE ];   /* 1 */
extern const byte Lint12Beta1[ LDIGIT_SIZE ];   /* base - 1 */
